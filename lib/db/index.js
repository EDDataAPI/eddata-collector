...
const [
  ...
  // Performance optimizations for large databases (trade.db can be 4GB+)
  db.pragma('cache_size = -2000000') // 2GB cache for 4GB+ DB
  db.pragma('temp_store = MEMORY') // Temp tables in RAM
  db.pragma('mmap_size = 4294967296') // 4GB Memory-Mapped I/O
